...
argocd app create devfest-secret-manager --repo https://github.com/anthonydurot/devfest-2021.git --revision recuperation-java-secrets-manager --path kubernetes/application --dest-server https://kubernetes.default.svc --dest-namespace devfest-cicd-injection --sync-option CreateNamespace=true --sync-policy automatic