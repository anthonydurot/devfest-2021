...
argocd app create devfest-vault --repo https://github.com/anthonydurot/devfest-2021.git --revision recuperation-java-vault --path kubernetes/application --dest-server https://kubernetes.default.svc --dest-namespace devfest-vault --sync-option CreateNamespace=true --sync-policy automatic